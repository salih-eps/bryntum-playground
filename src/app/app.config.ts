import { EventModelConfig, ResourceModelConfig, ResourceTimeRangeModelConfig } from '@bryntum/scheduler';
import { BryntumSchedulerProps } from '@bryntum/scheduler-angular';

const resources : ResourceModelConfig[] = [
    { id : 'r1', name : 'Mike' },
    { id : 'r2', name : 'Linda' },
    { id : 'r3', name : 'Don' },
    { id : 'r4', name : 'Karen' },
